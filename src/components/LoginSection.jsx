...
function LoginSection() {
    ...
    return (
        ...
        <div className="login-container">
            <h1 className="login-heading">Welcome to the Countdown Board for Project Management</h1>
            <p className="login-subheading">Please {isSignInActive ? "Sign In" : "Sign Up"} to continue</p>
            <div className="content-wrapper">
                <div className="image-container">
                    <img src={loginImage} alt="Attendance Management System" className="attendance-image" />
                </div>
                <div className="form-container">
                    <form className="form">
                        <h2>{isSignInActive ? <span style={{ color: "#0105e9" }}>Sign In</span> : <span style={{ color: "#0105e9" }}>Sign Up</span>}</h2>
